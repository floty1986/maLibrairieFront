...
<c:if test="${!panierVide}">
    <c:forEach var="i" items="${list}">
        ...
        <a href='controller?section=panier&dec=${i.idOuvrage}'><input type="submit" value="Retirer 1" name="retrait"  class="btn_plus"/></a>
        <a href='controller?section=panier&del=${i.idOuvrage}'><input type="submit" value="Supprimer" name="suppression" class="btn_moins"/></a>
